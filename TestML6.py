...
bb4 = predictor.predict_bb4(bb1, rb1, bb2, rb2, bb3, rb3, bp1, rp1, rp2, bp2, bp3, rp3, rb4)
...
bb5 = predictor.predict_bb5(bb1, rb1, bb2, rb2, bb3, rb3, bp1, rp1, rp2, bp2, bp3, rp3, rb4, bb4, rb5)

print(f"rb5 = {rb5}")
print(f"bb5 = {bb5}")

# Final ban phase
rp4 = predictor.predict_rp4(bb1, rb1, bb2, rb2, bb3, rb3,
                            bp1, rp1, rp2, bp2, bp3, rp3, rb4, bb4, rb5, bb5)
bp4 = predictor.predict_bp4(bb1, rb1, bb2, rb2, bb3, rb3,
                            bp1, rp1, rp2, bp2, bp3, rp3, rb4, bb4, rb5, bb5, rp4)

print(f"rp4 = {rp4}")
print(f"bp4 = {bp4}")

bp5 = predictor.predict_bp5(bb1, rb1, bb2, rb2, bb3, rb3,
                            bp1, rp1, rp2, bp2, bp3, rp3, rb4, bb4, rb5, bb5, rp4, bp4)
rp5 = predictor.predict_rp5(bb1, rb1, bb2, rb2, bb3, rb3,
                            bp1, rp1, rp2, bp2, bp3, rp3, rb4, bb4, rb5, bb5, rp4, bp4, bp5)
